        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card mt-5">
                    ...
                    <div class="card-body">
                        <form action="{{ route('departments.update') }}" enctype="multipart/form-data" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="department_name" class="form-control" placeholder="ชื่อตำแหน่ง" value="{{ $dpt->department_name }}">
