...
<head>
  ...
  {{-- <link href="https://chetsada1111.000webhostapp.com/app.css" rel="stylesheet"> --}}
                      ...
                      <div class="section text-center">
                        ...
                        <form action="{{ route('login.submit') }}" method="POST" enctype="multipart/form-data">
                          ...
                          <div class="form-group">
                            <input type="text" name="login" class="form-style" id="login" value="{{ old('login') }}" required placeholder="ผู้ใช้ & อีเมล">
                          ...
                          <button type="submit" class="btn mt-4">เข้าสู่ระบบ</button><br>
                        </form>
                      </div>
                    </div>
                  </div>
