                                    ...
                                    <td>
                                        <form action="{{ route('departments.delete', $department->id) }}" method="POST"
                                            ...
                                            <button type="submit" class="btn btn-danger btn-sm show_confirm"
                                                data-name="{{ $department->department_name }}" title="ลบ">
                    ...
                    <form action="{{ route('departments.store') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="department_name" name="department_name"
                                pattern="[\p{Thai}a-zA-Z]+"
                                title="ชื่อต้องเป็นตัวอักษรไทยหรือภาษาอังกฤษและต้องมีอย่างน้อย 1 ตัวอักษรไทย" required>
                        </div>
                        <div class="d-flex justify-content-between">
                            <button type="submit" class="btn btn-success">บันทึก</button>
